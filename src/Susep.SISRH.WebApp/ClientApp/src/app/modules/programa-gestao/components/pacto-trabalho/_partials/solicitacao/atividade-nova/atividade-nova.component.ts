...
export class AtividadesPactoNovaComponent implements OnInit {
  ...
  mudarItemCatalogo(value) {
    ...
    this.tempoItemSelecionado = this.decimalValuesHelper.toPtBr(this.dadosPacto.value.formaExecucaoId === 101 ? itemSelecionado.tempoExecucaoPresencial : itemSelecionado.tempoExecucaoRemoto);
