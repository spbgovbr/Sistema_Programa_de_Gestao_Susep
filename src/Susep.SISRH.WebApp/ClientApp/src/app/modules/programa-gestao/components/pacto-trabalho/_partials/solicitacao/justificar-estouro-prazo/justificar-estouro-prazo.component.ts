...
@Component({
  selector: 'justificar-estouro-prazo',
  templateUrl: './justificar-estouro-prazo.component.html',
})
export class JustificarEstouroPrazoPactoComponent implements OnInit {
  ...
  justificarEstouroDePrazo() {
    if (this.form.valid) {
      ...
      const dados: IJustificarEstouroPrazoAtividade = {
      ...
      this.pactoTrabalhoDataService.JustificarEstouroPrazo(dados).subscribe(
