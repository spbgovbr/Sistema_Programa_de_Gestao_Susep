...
{
    public enum ClassificacaoCatalogoDominioEnum
    {
        FormaCalculoTempoItemCatalogo,
        ModalidadeExecucao,
        SituacaoPlanoTrabalho,
        SituacaoPactoTrabalho,
        SituacaoAtividadePactoTrabalho,
        TipoSolicitacaoPactoTrabalho,
