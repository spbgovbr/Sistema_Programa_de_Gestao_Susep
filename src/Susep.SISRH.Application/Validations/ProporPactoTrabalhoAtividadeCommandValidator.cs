...
{
    public class ProporPactoTrabalhoAtividadeCommandValidator : AbstractValidator<ProporPactoTrabalhoAtividadeCommand>
    {

        public ProporPactoTrabalhoAtividadeCommandValidator()
        {
