...
{
    public class CadastrarPlanoTrabalhoMetaCommandHandler : IRequestHandler<CadastrarPlanoTrabalhoMetaCommand, IActionResult>
    {
        private IPlanoTrabalhoRepository PlanoTrabalhoRepository { get; }
        private IUnitOfWork UnitOfWork { get; }

        public CadastrarPlanoTrabalhoMetaCommandHandler(            
        ...
        public async Task<IActionResult> Handle(CadastrarPlanoTrabalhoMetaCommand request, CancellationToken cancellationToken)
        {
            ...
            //Remove a meta
            item.AdicionarMeta(request.Meta, request.Indicador, request.Descricao);
