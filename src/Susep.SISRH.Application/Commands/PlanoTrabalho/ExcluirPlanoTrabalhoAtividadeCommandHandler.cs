...
{
    public class ExcluirPlanoTrabalhoAtividadeCommandHandler : IRequestHandler<ExcluirPlanoTrabalhoAtividadeCommand, IActionResult>
    {
        private IPlanoTrabalhoRepository PlanoTrabalhoRepository { get; }
        private IUnitOfWork UnitOfWork { get; }

        public ExcluirPlanoTrabalhoAtividadeCommandHandler(            
        ...
        public async Task<IActionResult> Handle(ExcluirPlanoTrabalhoAtividadeCommand request, CancellationToken cancellationToken)
        {
            ...
            //Remove a atividade
            item.RemoverAtividade(request.PlanoTrabalhoAtividadeId);
