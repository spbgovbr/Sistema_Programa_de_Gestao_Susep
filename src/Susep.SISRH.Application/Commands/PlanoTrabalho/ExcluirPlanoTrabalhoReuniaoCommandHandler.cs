...
{
    public class ExcluirPlanoTrabalhoReuniaoCommandHandler : IRequestHandler<ExcluirPlanoTrabalhoReuniaoCommand, IActionResult>
    {
        private IPlanoTrabalhoRepository PlanoTrabalhoRepository { get; }
        private IUnitOfWork UnitOfWork { get; }

        public ExcluirPlanoTrabalhoReuniaoCommandHandler(            
        ...
        public async Task<IActionResult> Handle(ExcluirPlanoTrabalhoReuniaoCommand request, CancellationToken cancellationToken)
        {
            ...
            //Remove a reunião
            item.RemoverReuniao(request.PlanoTrabalhoReuniaoId);
