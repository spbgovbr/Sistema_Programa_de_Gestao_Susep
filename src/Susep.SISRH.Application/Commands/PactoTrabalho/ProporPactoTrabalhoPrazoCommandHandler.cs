...
{
    public class ProporPactoTrabalhoPrazoCommandHandler : IRequestHandler<ProporPactoTrabalhoPrazoCommand, IActionResult>
    {
        ...
        public ProporPactoTrabalhoPrazoCommandHandler(
        ...
        public async Task<IActionResult> Handle(ProporPactoTrabalhoPrazoCommand request, CancellationToken cancellationToken)
        {
            ...
            //Cria a solicitação
            pacto.AdicionarSolicitacao(TipoSolicitacaoPactoTrabalhoEnum.AlterarPrazo, request.UsuarioLogadoId.ToString(), dados, request.Descricao);
        ...
        private void EnviarEmail(string[] destinatarios)
        {
            ...
            if (destinatarios.Any())
            {
                ...
                mensagem.AppendLine($"Prezado(a), ").AppendLine("")
                        .AppendLine("Uma alteração do prazo de um plano de trabalho em que você está envolvido foi solicitada.").AppendLine("")
                        .AppendLine("Acompanhe o andamento por meio do sistema.");

                EmailHelper.Send(
                    "naoresponda@susep.gov.br",
                    "[Programa de gestão] Proposta de alteração de prazo",
                    destinatarios,
