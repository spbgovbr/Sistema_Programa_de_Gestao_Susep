        ...
        private void EnviarEmail(string[] destinatarios)
        {
            ...
            if (destinatarios.Any())
            {
                ...
                mensagem.AppendLine($"Prezado(a), ").AppendLine("")
                        .AppendLine("Houve alteração da situação de um plano de trabalho em que você está envolvido.").AppendLine("")
                        .AppendLine("Acompanhe o andamento por meio do sistema.");

                EmailHelper.Send(
                    "naoresponda@susep.gov.br",
                    "[Programa de gestão] Alteração da situação de plano de trabalho",
                    destinatarios,
