...
{
    public class AlterarPactoTrabalhoAtividadeCommandHandler : IRequestHandler<AlterarPactoTrabalhoAtividadeCommand, IActionResult>
    {
        ...
        public AlterarPactoTrabalhoAtividadeCommandHandler(
        ...
        public async Task<IActionResult> Handle(AlterarPactoTrabalhoAtividadeCommand request, CancellationToken cancellationToken)
        {
            ...
            //Altera a atividade
            pacto.AlterarAtividade(request.PactoTrabalhoAtividadeId, item, request.Quantidade, modalidaExecucaoId, tempoPrevisto, request.Descricao, request.AssuntosId, request.ObjetosId);
