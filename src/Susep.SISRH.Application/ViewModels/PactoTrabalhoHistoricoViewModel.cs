...
{
    [DataContract(Namespace = "http://www.susep.gov.br/sisrh/viewmodels/", Name = "PactoTrabalhoHistorico")]
    public class PactoTrabalhoHistoricoViewModel
    {

        [DataMember(Name = "pactoTrabalhoHistoricoId")]
